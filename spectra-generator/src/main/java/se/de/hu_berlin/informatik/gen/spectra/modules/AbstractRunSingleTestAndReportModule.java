 ...
 * @author Simon Heiden
 */
public abstract class AbstractRunSingleTestAndReportModule<T extends Serializable, R> extends AbstractProcessor<TestWrapper, R> {
	...
	private AbstractRunTestInNewJVMModule<T> getTestRunInNewJVMModule() {
	...
	public abstract AbstractRunTestInNewJVMModule<T> newTestRunInNewJVMModule();
