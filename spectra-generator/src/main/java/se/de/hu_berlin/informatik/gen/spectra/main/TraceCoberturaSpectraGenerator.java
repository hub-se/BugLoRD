 ...
 * @author Simon Heiden
 */
final public class TraceCoberturaSpectraGenerator extends AbstractSpectraGenerator {
    ...
    public static void main(final String[] args) {
        ...
        final OptionParser options = OptionParser.getOptions("TraceCoberturaToSpectra", false, CmdOptions.class, args);
...
//		new CoberturaSpectraGenerator().generateSpectra(
...
//				maxErrors, null, null, classesToInstrument);
    ...
    public static class Builder extends AbstractBuilder {
        ...
        @Override
        public void run() {
            AbstractSpectraGenerationFactory<?, ?, ?> factory = new TraceCoberturaSpectraGenerationFactory(outputDir);
