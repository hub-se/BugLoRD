 ...
 * @author Simon Heiden
 */
public class CoberturaRunTestInNewJVMModule extends AbstractRunTestInNewJVMModuleWithServer<ProjectData> {

    final private String[] args;

    public CoberturaRunTestInNewJVMModule(final String testOutput,
