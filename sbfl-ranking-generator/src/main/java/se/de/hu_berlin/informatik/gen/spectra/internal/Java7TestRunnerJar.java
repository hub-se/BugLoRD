 ...
 * public Java API.
 */
public final class Java7TestRunnerJar {

	/**
	 * Name of the agent JAR file resource within this bundle.
	 */
	private static final String RESOURCE = "/testrunner.jar";

	private Java7TestRunnerJar() {
	}
	...
	public static URL getResource() {
		final URL url = Java7TestRunnerJar.class.getResource(RESOURCE);
		if (url == null) {
	...
	public static InputStream getResourceAsStream() {
		final InputStream stream = Java7TestRunnerJar.class.getResourceAsStream(RESOURCE);
		if (stream == null) {
			throw new AssertionError(ERRORMSG);
		}
		return stream;
	...
	public static File extractToTempLocation() throws IOException {
		final File agentJar = File.createTempFile("testrunner", ".jar");
	...
	private static final String ERRORMSG = String.format(
			"The resource %s has not been found.", RESOURCE);
