...
public class MyJUnitTestRunner implements TestListener, JUnitTaskMirror.JUnitTestRunnerMirror {
     ...
     */
    public MyJUnitTestRunner(final JUnitTest test, final boolean haltOnError,
     ...
     * @since 1.8.2
     */
    public MyJUnitTestRunner(final JUnitTest test, final String[] methods, final boolean haltOnError,
                           final boolean filtertrace, final boolean haltOnFailure,
                           final boolean showOutput, final boolean logTestListenerEvents) {
    ...
    public MyJUnitTestRunner(final JUnitTest test, final String[] methods, final boolean haltOnError,
                           ...
                           final ClassLoader loader) {
        super();
        MyJUnitTestRunner.filtertrace = filtertrace; // TODO clumsy, should use instance field somehow
        this.junitTest = test;
    ...
    private static void transferFormatters(final MyJUnitTestRunner runner,
    ...
    public static String getFilteredTrace(final Throwable t) {
        ...
        return MyJUnitTestRunner.filterStack(trace);
    }
    ...
    private static int launch(final JUnitTest t, final String[] methods, final boolean haltError,
        ...
        final MyJUnitTestRunner runner =
            new MyJUnitTestRunner(t, methods, haltError, stackfilter, haltFail, showOut,
                                logTestListenerEvents, null);
        runner.forked = true;
