...
import se.de.hu_berlin.informatik.stardust.provider.tracecobertura.coveragedata.Arguments;
import se.de.hu_berlin.informatik.stardust.provider.tracecobertura.coveragedata.ArgumentsBuilder;
import se.de.hu_berlin.informatik.stardust.provider.tracecobertura.coveragedata.CodeInstrumentationTask;
...
//			}
			...
			try {
				TraceProjectData projectData = new TraceProjectData();
