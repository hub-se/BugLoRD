...
public class StatementToBranchingSpectraModule extends AbstractProcessor<ISpectra<SourceCodeBlock, ?>, ISpectra<Integer, ?>> {

    public StatementToBranchingSpectraModule() {
        super();
    }
     ...
     */
/**    @Override public ISpectra<Integer,?> processItem(final ISpectra<SourceCodeBlock,?> input) {
