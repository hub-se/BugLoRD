 ...
 *
 * @param <T> the type of nodes in the spectra to provide
 * @param <K> the type of traces in the specra
 * @param <D> the type of the coverage data that is used
 * @author Simon
 */
public abstract class AbstractSpectraProvider<T, K extends ITrace<T>, D> implements ISpectraProvider<T, K> {
     ...
     * provider.
     *
     * @param lineSpectra a new spectra instance
     * @param fullSpectra whether to add all nodes contained in the data or only the covered nodes
     */
     ...
     *
     * @param data a coverage data object
