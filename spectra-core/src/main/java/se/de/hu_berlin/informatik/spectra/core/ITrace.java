...
public interface ITrace<T> {
     ...
     *
     * @param identifier the node to set the involvement for
     * @param involved   true if the node was involved, false otherwise
     */
     ...
     *
     * @param node     the node to set the involvement for
     * @param involved true if the node was involved, false otherwise
     */
     ...
     * with the given identifier exists, it will be created.
     *
     * @param index    the node index to set the involvement for
     * @param involved true if the node was involved, false otherwise
     */
     ...
     *
     * @param involvement a map of node-involvement pairs
     */
     ...
     * Checks whether the given node is involved in the current trace.
     *
     * @param identifier the identifier of the node to check
    ...
    /**
     * @return the number of nodes that are involved with this trace
     */
    public int involvedNodesCount();

    /**
     * @return a collection holding all involved nodes
     */
    public Collection<Integer> getInvolvedNodes();

    /**
     * @return a collection holding all execution traces for all threads
     */
...
//    public Collection<byte[]> getExecutionTracesByteArrays();
     ...
     *
     * @param executionTrace a list of executed nodes for one thread
     */
    public abstract void addExecutionTrace(ExecutionTrace executionTrace);

    /**
     * @return the identifier (usually the test case name) of the trace
     */
    public String getIdentifier();

    /**
     * @return the integer index of the trace
     */
    public int getIndex();
