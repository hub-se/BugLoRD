...
public interface IKeyWordDispatcher {
     ...
     *
     * @param keyWord the keyword for choosing the node to create
     * @param token   the complete token
     * @param info    an object that holds relevant information about current variable scopes,
     *                etc.
     * @param <T>     the type of returned nodes
     * @return the parsed node
     * @throws ClassCastException if the returned node can not be cast to the type T
     */
