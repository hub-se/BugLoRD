...
public interface IAbstractionMapper extends IAbstractionMapperBasics, IModifierHandler, IOperatorHandler, ITypeHandler {
	...
	public static int expresssionAbstraction(int absDepth) {
		return 0;
	}
	
	public static int statementsAbstraction(int absDepth) {
		return 0;
	}
	...
	public default String getMappingForMemberValuePair(MemberValuePair aNode, int aAbsDepth, boolean includeParent) {
		...
		return applyCombination(
				...
				() -> getMappingForSimpleName(
						...
						false),
				() -> getMappingForExpression(aNode.getValue(), expresssionAbstraction(aAbsDepth), false));
	}
	...
	public default String getMappingForSwitchEntryStmt(SwitchEntryStmt aNode, int aAbsDepth, boolean includeParent) {
		...
		return applyCombination(
				...
				() -> getMappingForExpression(aNode.getLabel().orElse(null), expresssionAbstraction(aAbsDepth), false),
	...
	public default String getMappingForLambdaExpr(LambdaExpr aNode, int aAbsDepth, boolean includeParent) {
		...
		return applyCombination(
				...
				() -> getMappingForStatement(aNode.getBody(), statementsAbstraction(aAbsDepth), false),
	...
	public default String getMappingForInstanceOfExpr(InstanceOfExpr aNode, int aAbsDepth, boolean includeParent) {
		...
		return applyCombination(
				...
				() -> getMappingForExpression(aNode.getExpression(), expresssionAbstraction(aAbsDepth), false),
	...
	public default String getMappingForConditionalExpr(ConditionalExpr aNode, int aAbsDepth, boolean includeParent) {
		...
		return applyCombination(
				...
				() -> getMappingForExpression(aNode.getCondition(), expresssionAbstraction(aAbsDepth), false),
	...
	public default String getMappingForArrayCreationExpr(ArrayCreationExpr aNode, int aAbsDepth,
		...
		return applyCombination(
				...
				() -> getMappingForExpression(aNode.getInitializer().orElse(null), expresssionAbstraction(aAbsDepth), false));
	}
	...
	public default String getMappingForArrayAccessExpr(ArrayAccessExpr aNode, int aAbsDepth, boolean includeParent) {
		...
		return applyCombination(
				...
				() -> getMappingForExpression(aNode.getName(), expresssionAbstraction(aAbsDepth), false),
	...
	public default String getMappingForMethodDeclaration(MethodDeclaration aNode, int aAbsDepth,
		...
		return applyCombination(
				...
				() -> getMappingForStatement(aNode.getBody().orElse(null), statementsAbstraction(aAbsDepth), false));
	}
	...
	public default String getMappingForSwitchStmt(SwitchStmt aNode, int aAbsDepth, boolean includeParent) {
		...
		return applyCombination(
				...
				() -> getMappingForExpression(aNode.getSelector(), expresssionAbstraction(aAbsDepth), false),
	...
	public default String getMappingForForStmt(ForStmt aNode, int aAbsDepth, boolean includeParent) {
		...
		return applyCombination(
				...
				() -> getMappingForExpression(aNode.getCompare().orElse(null), expresssionAbstraction(aAbsDepth), false),
