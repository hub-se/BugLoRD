...
public interface INodeGuesserBasics {
     ...
     * information.
     *
     * @param expectedSuperClazz the expected type of the node
     * @param info               the currently available information
     * @param <T>                the type of node returned
     ...
     *
     * @param expectedSuperClazz the expected type of the nodes in the list
     * @param listMemberCount    the number of list elements in the original list
     * @param info               the currently available information
