 ...
 *
 */
public class ExpAdvNode2StringMappingWithSerializationShort extends ExperimentalAdvancedNode2StringMappingShort {
	 ...
	 */
	public ExpAdvNode2StringMappingWithSerializationShort( int aMaxSerializationChildren ) {
