...
public interface IAbstractionMapperBasics extends IMapper<String> {
     ...
     *
     * @param list              The list of type parameters
     * @param aAbsDepth         The depth of the mapping
     * @param getMappingForT    a function that gets a mapping for an object of type T
     * @param alwaysUseFullList whether to always get Tokens for the full list
     * @param nextNodes         a list of child nodes to generate tokens for next
     * @param <T>               the type of objects in the list
     * @param <P>               the type of parent nodes
     ...
     *
     * @param nodes             the list of nodes that should be mapped
     * @param aAbsDepth         the depth of the mapping
     * @param alwaysUseFullList whether to always get Tokens for the full list
     * @param nextNodes         a list of child nodes to generate tokens for next
     * @return A token that represents the mapping with the given depth
     ...
     *
     * @param vars              the list of variable declarators that should be mapped
     * @param aAbsDepth         the depth of the mapping
     * @param alwaysUseFullList whether to always get Tokens for the full list
     * @param nextNodes         a list of child nodes to generate tokens for next
     * @return A token that represents the mapping with the given depth
     ...
     *
     * @param types             the list of types that should be mapped
     * @param aAbsDepth         the depth of the mapping
     * @param alwaysUseFullList whether to always get Tokens for the full list
     * @param nextNodes         a list of child nodes to generate tokens for next
     * @return A token that represents the mapping with the given depth
     ...
     *
     * @param statements        the list of statements that should be mapped
     * @param aAbsDepth         the depth of the mapping
     * @param alwaysUseFullList whether to always get Tokens for the full list
     * @param nextNodes         a list of child nodes to generate tokens for next
     * @return A token that represents the mapping with the given depth
     ...
     *
     * @param levels            the list of array creation levels
     * @param aAbsDepth         the depth of the mapping
     * @param alwaysUseFullList whether to always get Tokens for the full list
     * @param nextNodes         a list of child nodes to generate tokens for next
     * @return A token that represents the mapping with the given depth
     ...
     * Creates a mapping for a list of body declarations.
     *
     * @param types             the list of body declarations
     * @param aAbsDepth         the depth of the mapping
     * @param alwaysUseFullList whether to always get Tokens for the full list
     * @param nextNodes         a list of child nodes to generate tokens for next
     * @return A token that represents the mapping with the given depth
