...
public interface ITypeHandler {
     ...
     * <p>
     * Expected token format: {@code T} or {@code F}.
     *
     ...
     * <p>
     * Expected token format: {@code ~} (null) or {@code s}.
     *
     * @param token the token to parse
    ...
    public default String getMappingForChar(String value) {
        // TODO: maybe use two characters to mark occurrences of special
        // characters? Then, they could be parsed to the original value...
        return getParseableString(value);
    }
