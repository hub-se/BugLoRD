...
import se.de.hu_berlin.informatik.rankingplotter.modules.*;
...
public class Plotter {
    ...
    /**
     * @param args -i input-dir [(-p|-a) loc1 loc2 ...] -o output-dir output-prefix [-r range] [-l] [-pdf] [-png] [-u unranked-file] [-m ranked-file] [-s] [-z]
     */
