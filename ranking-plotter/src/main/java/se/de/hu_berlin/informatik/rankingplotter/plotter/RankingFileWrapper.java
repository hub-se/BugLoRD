...
public class RankingFileWrapper implements Comparable<RankingFileWrapper> {
     ...
     * @param combinedRanking   the combined ranking
     * @param sBFL              the percentage value of the SBFL ranking
     * @param changeInformation a map containing all modifications
     * @param strategy          which strategy to use. May take the lowest or the highest ranking
     ...
     *
     * @param changeInformation a map containing all modifications (the keys are the file names/paths)
     * @param strategy          which strategy to use. May take the lowest or the highest ranking
     *                          of a range of equal-value rankings or may compute the average
     */
    ...
    /**
     * @return the percentage value of the SBFL ranking not divided by 100
     */
    ...
    /**
     * @return the percentage value of the SBFL ranking
     */
