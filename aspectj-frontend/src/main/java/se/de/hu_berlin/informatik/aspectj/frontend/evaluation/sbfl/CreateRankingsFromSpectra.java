...
public class CreateRankingsFromSpectra {
     ...
     */
    final List<IFaultLocalizer<SourceCodeBlock>> faultLocalizers = new ArrayList<>();
    /**
     * Path to results
     */
    ...
    final ISpectraProviderFactory<SourceCodeBlock> spectraProviderFactory;
    final Prop prop;

    /**
     * Setup experiment
     *
     * @param threads          number of concurrent experiments to run
     * @param useDefaultBugIDs whether to use default bug IDs or to use all IDs found in the directory
    ...
    public CreateRankingsFromSpectra(int threads, boolean useDefaultBugIDs) throws JDOMException, IOException {
        ...
        if (useDefaultBugIDs) {
            this.bugIds = new int[]{
                    28919, 28974, 29186, 29959, 30168, 32463, 33635, 34925, 36430, 36803,
                    37576, 37739, 38131, 39626, 39974, 40192, 40257, 40380, 40824, 42539,
                    42993, 43033, 43194, 43709, 44117, 46298, 47318, 49657, 50776, 51320,
                    51929, 52394, 54421, 54965, 55341, 57436, 57666, 58520, 59596, 59895,
                    61411, 62227, 64069, 64331, 67592, 69011, 70008, 71377, 71878, 72150,
                    72528, 72531, 72671, 73433, 74238, 77799, 81846, 81863, 82134, 82218,
                    83563, 86789, 87376, 88652, 96371, 99168, 100227, 104218, 107299, 109016,
                    109614, 113257, 114875, 115251, 115275, 116626, 116949, 118192, 118715, 118781,
                    119353, 119451, 119539, 119543, 120351, 120474, 122370, 122728, 123695, 124654,
                    124808, 125480, 125699, 125810, 128128, 128237, 128655, 128744, 129566, 130837,
                    130869, 131505, 131932, 131933, 132130, 135001, 136665, 138143, 138219, 138223,
                    138286, 141956, 142165, 145086, 145693, 145950, 146546, 147701, 148409, 150671,
