...
public class LockableProjectData extends TraceProjectData {
	...
	public boolean subtract(TraceProjectData projectData) {
	...
	public static String projectDataToString(TraceProjectData projectData, boolean onlyUseCovered) {
	...
	public static boolean containsSameCoverage(TraceProjectData projectData, TraceProjectData OtherProjectData) {
...
//								Log.err(this, "Coverage doesn't match for method '%s', line %d.", methodNameAndSig, lineData.getLineNumber());
	...
	public static boolean containsCoveredLines(TraceProjectData projectData) {
		// loop over all packages
        @SuppressWarnings("unchecked")
	...
	public static boolean resetLines(TraceProjectData projectData) {
		// loop over all packages
        @SuppressWarnings("unchecked")
		Iterator<PackageData> itPackages = projectData.getPackages().iterator();
		while (itPackages.hasNext()) {
