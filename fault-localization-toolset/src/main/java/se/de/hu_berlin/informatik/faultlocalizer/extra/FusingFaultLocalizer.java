...
public class FusingFaultLocalizer<T> implements IFaultLocalizer<T> {
     ...
     *
     * @param normalization strategy to use
     * @param selection     strategy to use
     * @param dataFusion    strategy to use
     */
     ...
     *
     * @param rankings the rankings to extract the top nodes from
     ...
     *
     * @param rankings rankings of different FL algorithms
     * @param topK     all sets of topK nodes for each FL
     ...
     *
     * @param sortby the score to sort the techniques by
     * @param n      the percentage of techniques to select
     ...
     *
     * @param localizer spectra ranking is backed on
     * @param selected  selected techniques
     * @param rankings  rankings of all techniques
     * @return new ranking
     */
