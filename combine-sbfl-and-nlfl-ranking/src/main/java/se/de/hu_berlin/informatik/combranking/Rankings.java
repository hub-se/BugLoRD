...
public class Rankings implements Comparable<Rankings> {
	 ...
	 */
	public void setCombinedRanking(final double lambda, final double max_ranking) {
		if (lambda == 0 && !Double.isFinite(this.SBFLRanking)) {
	 ...
	 */
	public void setCombinedRanking(final double lambda, final double max_globalranking, 
