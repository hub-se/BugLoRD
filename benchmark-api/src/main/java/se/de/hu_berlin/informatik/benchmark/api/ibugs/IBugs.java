...
public class IBugs {
     ...
     * repository
     *
     * @param aFixedId The id of the bug that should be checked out
     ...
     *
     * @param aFixedId The id of the bug for the repository that should be build
     ...
     *
     * @param aFixedId      The id of the bug for the repository that should be build
     * @param aTargetPreFix If true the pre fix repository will be targeted else the post
     *                      fix one is used
     * @param aTestFileName the name of the test file (relative to the base directory of
     *                      the version, e.g. 'org.aspectj/modules/tests/ajcTests.xml'
     * @param aTestName     the name of the test to execute
     * @param aVMArgs       Arguments that are to be passed to the virtual machine when
