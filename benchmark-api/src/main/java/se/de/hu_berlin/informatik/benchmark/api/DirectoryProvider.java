...
public interface DirectoryProvider {
    ...
    /**
     * @return the path to the main archive directory
     */
    public String getBenchmarkArchiveDir();

    /**
     * @return the path to the main execution directory
     */
    ...
    /**
     * @param executionMode whether to use the execution directory version
     * @return the path to the main benchmark directory
     */
...
//		result.toFile().mkdirs();
    ...
    /**
     * @return the relative entity path, starting from the main benchmark directory
     */
    public Path getRelativeEntityPath();

    /**
     * @return an identifier for the entity; will be used as a directory name
     */
    public String getEntityIdentifier();

    /**
     * @param executionMode whether to use the execution directory version
     * @return the path to the working directory which is the path:
...
//		result.toFile().mkdirs();
    ...
    /**
     * @return the path to the data directory related to the entity
     */
