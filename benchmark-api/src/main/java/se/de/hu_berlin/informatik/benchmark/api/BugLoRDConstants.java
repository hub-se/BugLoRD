...
public class BugLoRDConstants {

	public static final String DATA_DIR_NAME = ".BugLoRD_data";
...
//	public static final String FILENAME_LM_RANKING = ".lm_ranking";
	...
	public static final int MAX_PRE_TOKENS_COUNT = 6;
	public static final int MAX_POST_TOKENS_COUNT = 6;
