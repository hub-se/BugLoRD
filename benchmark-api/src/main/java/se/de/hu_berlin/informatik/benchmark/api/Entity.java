...
public interface Entity {
     ...
     *
     * @param executionMode  whether execution directories should be used
     * @param deleteExisting whether to delete already existing directories
    ...
    /**
     * @return whether the given entity has already been initialized
     */
     ...
     *
     * @param executionMode whether the source files are located in the execution directory
     * @return true if successful; false otherwise
     */
    ...
    /**
     * @return the directory provider of this entity
     */
    public DirectoryProvider getDirectoryProvider();

    /**
     * @param executionMode whether the execution directory version should be returned
     * @return the main path in which all entity directories should be located
     */
    ...
    /**
     * @param executionMode whether the execution directory version should be returned
     * @return the actual working directory which should be the main path to the project, usually
     */
    ...
    /**
     * @return the data directory of this entity
     */
     ...
     *
     * @param executionMode whether the execution directory version should be used
    ...
    /**
     * @param executionMode whether the execution directory version should be returned
     * @return the path to the main source directory
     * @throws UnsupportedOperationException if this operation is not implemented
     */
    ...
    /**
     * @param executionMode whether the execution directory version should be returned
     * @return the path to the main test source directory
     * @throws UnsupportedOperationException if this operation is not implemented
     */
    ...
    /**
     * @param executionMode whether the execution directory version should be returned
     * @return the path to the main binaries directory
     * @throws UnsupportedOperationException if this operation is not implemented
     */
    ...
    /**
     * @param executionMode whether the execution directory version should be returned
     * @return the path to the main test binaries directory
     * @throws UnsupportedOperationException if this operation is not implemented
     */
     ...
     *
     * @param force whether to force deletion, even if the execution directory is equal to the archive directory
     */
    ...
    /**
     * @param executionMode whether the execution directory version should be used
     * @return the class path that is needed to execute the project
     * @throws UnsupportedOperationException if this operation is not implemented
     */
    ...
    /**
     * @param executionMode whether the execution directory version should be used
     * @return the class path that is needed to execute the project's tests
     * @throws UnsupportedOperationException if this operation is not implemented
     */
    ...
    /**
     * @param executionMode whether the execution directory version should be used
     * @return the list of test case identifiers that may be executed
     * @throws UnsupportedOperationException if this operation is not implemented
     */
    ...
    /**
     * @param executionMode whether the execution directory version should be used
     * @return the list of test classes that are given in the project
     * @throws UnsupportedOperationException if this operation is not implemented
     */
