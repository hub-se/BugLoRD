...
public interface Bug {
     ...
     *
     * @param faultLocationsFile a file with fault locations
     ...
     *
     * @param file           to add
     * @param faultLocations the location of faults in the given file
     ...
     *
     * @param file to get
     * @return fault locations, or null if none exists
     */
