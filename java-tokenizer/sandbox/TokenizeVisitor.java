 ...
 */
public class TokenizeVisitor implements VoidVisitor<Object> {

//    private boolean printComments;

    private List<Integer> lineNumbers = null;
    private boolean tokenizeLines = false;


    public TokenizeVisitor() {
//        this(true);
        printer = createSourcePrinter();
    }

//    public TokenizeVisitor(boolean printComments) {
//        this.printComments = printComments;
//    }

    public TokenizeVisitor(List<Integer> lineNumbers) {
        this.lineNumbers = lineNumbers;
        this.tokenizeLines = true;
        printer = createSourcePrinter(true);
    }
    ...
    public static class SourcePrinter {
        ...
        private int parsedLineNumber = 0;
        ...
        /**
         * @return the parsedLineNumber
         */
        public int getParsedLineNumber() {
            return parsedLineNumber;
        }

        /**
         * @param parsedLineNumber the parsedLineNumber to set
         */
        public void setParsedLineNumber(int parsedLineNumber) {
            this.parsedLineNumber = parsedLineNumber;
        }
        ...
        public SourcePrinter(boolean tokenizeLines) {
            this.indentation = "";
        ...
        public void print(final String arg) {
            if (tokenizeLines) {
                while (currentLine > parsedLineNumber) {

                }
                if (currentLine == parsedLineNumber) {
                    buf.append(arg);
                } else {
                    if (buf.length() > 0) {
...
//		return new SourcePrinter("    ");
    ...
    protected SourcePrinter createSourcePrinter(boolean tokenizeLines) {
//		return new SourcePrinter("    ");
        return new SourcePrinter(tokenizeLines);
    }
     ...
     */
    public void setCurrentLine(int currentLine) {
        printer.setCurrentLine(currentLine);
        ;
    }
     ...
     */
    public int getParsedLineNumber() {
        return printer.getParsedLineNumber();
    }
     ...
     */
    public void setParsedLineNumber(int parsedLineNumber) {
        printer.setParsedLineNumber(parsedLineNumber);
    }
