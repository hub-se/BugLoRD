...
public class Tokenizer {
     ...
     *
     * @param st  {@link StreamTokenizer} that has a (Java source code) file as its input
     * @param eol states if ends of lines (EOL) should be incorporated
     */
...
//		st.slashStarComments(true);
     ...
     * @throws IOException may be thrown by the underlying {@link StreamTokenizer}
     */
