...
public class TokenizeLines {
    ...
    /**
     * @param args -s src-path -t traceFile -o sentence-output [-m] [-l] [-c [order]] [-w]
     */
     ...
     *
     * @param inputDir      the input main source directory, containing the Java source files
     * @param traceFile     the trace file based on which the sentences shall be generated (may be an
     *                      SBFL ranking file)
     * @param outputFile    the output file for the generated sentences
     * @param contextLength the length of the context of the generated sentences
     */
     ...
     * @param outputFile       the output file for the generated sentences
     * @param contextLength    the length of the context of the generated sentences
     * @param abstractionDepth the abstraction depth to use by the AST based tokenizer
     * @param includeParent    whether to include information about the parent node
     * @param childCountSteps  the grouping step width to use for grouping nodes based on their number of child nodes (log-based)
     * @param preTokenCount    the number of tokens to include that precede the actual line
     * @param postTokenCount   the number of tokens to include that succeed the actual line
     */
