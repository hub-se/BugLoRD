...
public class Tokenize {
    ...
    /**
     * @param args -i input-file/dir -o output-file/dir -t [#threads] [-c] [-m] [-w]
     */
     ...
     *
     * @param inputDir  the input directory, containing the Java source files
     * @param outputDir the output directory for the token files
     */
